...
http://rancher.flowz.com:8080/v2-beta/projects/$ENV_ID/services/$SERVICE_ID_AUTH?action=upgrade
...
http://rancher.flowz.com:8080/v2-beta/projects/$ENV_ID/services/$SERVICE_ID_LDAP?action=upgrade
...
http://rancher.flowz.com:8080/v2-beta/projects/$ENV_ID/services/$SERVICE_ID_USER?action=upgrade
