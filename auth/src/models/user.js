...
module.exports = mongoose.model(
  ...
  default : Date.now},provider: String,access_token:String,picture:String,social_uid:String,isEmailConfirm:String,application_type:String,isActive:String,isEmailVerified:String,veri_token:String,redirect_url:String},{strict: false}),
  'User'
);
